...
def plot_etf_prices_and_revenue(
    ...
    reference_etfs = ['SPDR MSCI World UCITS ETF', 'Vanguard S&P 500 ETF']
    corr_df = compute_correlations(index_labels, etf_daily_returns, reference_etfs)
    yearly_corr_dfs = compute_yearly_correlations(index_labels, etf_daily_returns, reference_etfs, all_years)
